package com.xzkj.operatorService.aop;


import com.xzkj.operatorService.annotation.DS;
...
public class DynamicDataSourceAspect {
    //切入点,@DS标记的类，和方法做切入
    @Pointcut("@annotation(com.xzkj.operatorService.annotation.DS)"
            + "|| @within(com.xzkj.operatorService.annotation.DS)")
