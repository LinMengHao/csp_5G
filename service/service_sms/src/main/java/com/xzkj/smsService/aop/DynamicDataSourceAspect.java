package com.xzkj.smsService.aop;


import com.xzkj.smsService.annotation.DS;
import com.xzkj.smsService.constants.DataSourceConstants;
import com.xzkj.smsService.context.DynamicDataSourceContextHolder;
...
public class DynamicDataSourceAspect {
    //切入点,@DS标记的类，和方法做切入
    @Pointcut("@annotation(com.xzkj.smsService.annotation.DS)"
            + "|| @within(com.xzkj.smsService.annotation.DS)")
