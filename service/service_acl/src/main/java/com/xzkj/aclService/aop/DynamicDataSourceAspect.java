package com.xzkj.aclService.aop;


import com.xzkj.aclService.annotation.DS;
...
public class DynamicDataSourceAspect {
    //切入点,@DS标记的类，和方法做切入
    @Pointcut("@annotation(com.xzkj.aclService.annotation.DS)"
            + "|| @within(com.xzkj.aclService.annotation.DS)")
