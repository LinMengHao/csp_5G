package com.xzkj.flowPassthrough.aop;



import com.xzkj.flowPassthrough.annotation.DS;
import com.xzkj.flowPassthrough.constants.DataSourceConstants;
import com.xzkj.flowPassthrough.context.DynamicDataSourceContextHolder;
...
public class DynamicDataSourceAspect {
    //切入点,@DS标记的类，和方法做切入
    @Pointcut("@annotation(com.xzkj.flowPassthrough.annotation.DS)"
            + "|| @within(com.xzkj.flowPassthrough.annotation.DS)")
