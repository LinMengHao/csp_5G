package com.xzkj.flowacl.generate;
...
public class CodeGenerate {
    ...
    public void run() {
        ...
        gc.setOutputDir("E:\\csp_5G\\wxservice\\flow_acl" + "/src/main/java");
        ...
        strategy.setInclude("acl_user_role");
