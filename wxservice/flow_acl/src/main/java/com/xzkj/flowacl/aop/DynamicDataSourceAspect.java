package com.xzkj.flowacl.aop;



import com.xzkj.flowacl.annotation.DS;
import com.xzkj.flowacl.constants.DataSourceConstants;
...
public class DynamicDataSourceAspect {
    //切入点,@DS标记的类，和方法做切入
    @Pointcut("@annotation(com.xzkj.flowacl.annotation.DS)"
            + "|| @within(com.xzkj.flowacl.annotation.DS)")
