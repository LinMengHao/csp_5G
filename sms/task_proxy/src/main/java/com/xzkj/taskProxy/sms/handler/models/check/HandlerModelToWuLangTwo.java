...
public class HandlerModelToWuLangTwo implements Runnable {
	public static Logger logger = LoggerFactory.getLogger("HandlerModelToWuLangTwo");
	...
	public HandlerModelToWuLangTwo(String companyId, String appId, String channelId, int curCount) {
	...
	public void run(){
		...
		try {
			...
			while((jsonStr = RedisUtils.fifo_pop(fifo_key))!=null){
				...
				String spid="1035";
				String login="admin";
				String pwd= MD5Utils.MD5Encode(login+"265!@9#8").toUpperCase();
				...
				content.put("mmsbody",contentArr);
