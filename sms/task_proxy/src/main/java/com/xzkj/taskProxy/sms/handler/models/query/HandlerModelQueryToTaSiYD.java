...
public class HandlerModelQueryToTaSiYD implements Runnable {
	...
	public HandlerModelQueryToTaSiYD(String companyId, String appId, String channelId, int curCount) {
