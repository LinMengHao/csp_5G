...
public class HandlerSignToHLGYD implements Runnable {
	...
	public HandlerSignToHLGYD(String companyId, String appId, String channelId, int curCount) {
...
//					multipartEntityBuilder.addPart(split[split.length-1],fileBody);
				...
				if("0".equals(resCode)){
					...
					logger.error("视频短信模板素材处理失败resCode：{},resMsg: {}",resCode,resMsg);
				}
