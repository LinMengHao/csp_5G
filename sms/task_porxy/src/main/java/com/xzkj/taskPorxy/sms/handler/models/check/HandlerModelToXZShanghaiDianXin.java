...
public class HandlerModelToXZShanghaiDianXin implements Runnable {
	public static Logger logger = LoggerFactory.getLogger("HandlerModelToXZShanghaiDianXin");
	...
	public HandlerModelToXZShanghaiDianXin(String companyId, String appId, String channelId, int curCount) {
		...
		try {
			...
			while((jsonStr = RedisUtils.fifo_pop(fifo_key))!=null){
				...
				try{
					...
					String CLIENT_SIID="22100700020006";
					String CLIENT_KEY="HZt7pD1wRo";
