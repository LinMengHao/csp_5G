...
public class HandlerBeiJingCmcc3 implements Runnable {

	public static Logger logger = LoggerFactory.getLogger("HandlerBeiJingCmcc3");
	...
	public HandlerBeiJingCmcc3(int linkSpeed, String channelId, String channelMmsId, JSONObject jsonChannel){
