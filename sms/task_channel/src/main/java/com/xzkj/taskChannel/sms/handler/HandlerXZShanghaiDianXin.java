...
public class HandlerXZShanghaiDianXin implements Runnable{
    public static Logger logger = LoggerFactory.getLogger("HandlerXZShanghaiDianXin");
    ...
    public HandlerXZShanghaiDianXin(int linkSpeed, String channelId, String channelMmsId, JSONObject jsonChannel){
