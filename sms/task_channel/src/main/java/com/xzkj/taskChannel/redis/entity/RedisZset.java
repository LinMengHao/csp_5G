package com.xzkj.taskChannel.redis.entity;
...
public class RedisZset extends RedisLock {
	 ...
	 * @return
	 */
	public int revrangeWithScore(Jedis j, String key, long start, long end, final List<Double> scores, final List<String> members) {
