...
public class HandlerShenZhenWuLangTwo implements Runnable {

	public static Logger logger = LoggerFactory.getLogger("HandlerShenZhenWuLangTwo");
	...
	public HandlerShenZhenWuLangTwo(int linkSpeed, String channelId, String channelMmsId, JSONObject jsonChannel){
