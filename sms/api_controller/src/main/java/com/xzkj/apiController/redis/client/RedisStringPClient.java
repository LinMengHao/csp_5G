package com.xzkj.apiController.redis.client;


import com.xzkj.apiController.redis.common.JedisDataSourcePool;
import com.xzkj.apiController.redis.common.SerializeUtil;
import com.xzkj.apiController.redis.entity.RedisString;
 ...
 * @author admin
 */
public class RedisStringPClient {
    /**
     * 日志记录
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(RedisStringPClient.class);
     ...
     * private construtor
     */
    public RedisStringPClient(String redisKey) {
    	try {
			// redis数据源
    ...
    private static class Inner {
        private static RedisStringPClient instance = new RedisStringPClient("platform_cache");
    }
     ...
     * @return instance
     */
    public static RedisStringPClient getRedisClient() {
    ...
    public static void set(String key, String value) {
        Jedis jedis = RedisStringPClient.getRedisClient().getJedis();
        try {
        	key = getKey(key);
