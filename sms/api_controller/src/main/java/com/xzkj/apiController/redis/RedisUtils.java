package com.xzkj.apiController.redis;

import com.xzkj.apiController.redis.client.*;
...
public class RedisUtils {
    ...
    public static String HASH_MODEL_RELATE_COUNT="mt_model_relate";
    public static String HASH_SIGN_RELATE_COUNT="mt_sign_relate";
