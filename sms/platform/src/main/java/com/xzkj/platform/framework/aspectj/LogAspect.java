package com.xzkj.platform.framework.aspectj;
...
import com.xzkj.platform.common.enums.BusinessStatus;
import com.xzkj.platform.common.utils.ServletUtils;
import com.xzkj.platform.common.utils.ShiroUtils;
import com.xzkj.platform.common.utils.StringUtils;
import com.xzkj.platform.framework.manager.AsyncManager;
import com.xzkj.platform.framework.manager.factory.AsyncFactory;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.xzkj.platform.common.annotation.Log)")
        ...
        try
        {
            ...
            if (currentUser != null)
            {
                ...
                if (StringUtils.isNotNull(currentUser.getDept())
                        && StringUtils.isNotEmpty(currentUser.getDept().getCompanyName()))
                {
                    operLog.setCompanyName(currentUser.getDept().getCompanyName());
                }
            }
