...
public interface IRouteBaseService
{
     ...
     */
    public List<RouteBase> selectRouteBaseList(RouteBase eRouteBase);
     ...
     * @return 结果
     */
    public int insertRouteBase(RouteBase eRouteBase);
     ...
     * @return 结果
     */
    public int updateRouteBase(RouteBase eRouteBase);

    /**
     * 批量删除路由信息e_route_base
     * 
     * @param ids 需要删除的路由信息e_route_base主键集合
     * @return 结果
     */
